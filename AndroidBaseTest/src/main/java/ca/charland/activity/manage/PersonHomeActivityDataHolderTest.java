...
public class PersonHomeActivityDataHolderTest {

	private static class TestPersonHomeActivityDataHolder extends PersonHomeActivityDataHolder {
	...
	private PersonHomeActivityDataHolder activity;
